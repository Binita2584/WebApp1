...
namespace WebApp1.Models
{
    ...
    {
        const string GETALL = "sp_GetAllProducts1";
        const string GETDETAILS = "sp_GetProductDetails1";
        const string INSERT = "sp_CreateProduct1";
        const string UPDATE = "sp_UpdateProduct1";
        SqlConnection connection;

        string connectionString = "Data Source=VINDHYA\\SQLDEV2016;initial catalog=northwind;integrated security=sspi";
